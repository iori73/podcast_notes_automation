...
#     def search_episode(self, title, language="English"):  # デフォルトを英語に変更
#         """タイトルからエピソードを検索"""
#         search_params = {
#             'q': title,
#             'type': 'episode',
#             'language': language,  # 言語パラメータを可変に
#             'safe_mode': 0,
#             'sort_by_date': 0,
#             'offset': 0,
#             'len_min': 0,
...
#                 data = response.json()
#                 if not data.get('results'):
#                     # 結果が見つからない場合は言語を英語に切り替えて再試行
#                     if language != "English":
#                         return self.search_episode(title, "English")
#                     return None
...
#     #         return episode.get('listennotes_url')
#     #     return None
#     def get_episode_url(self, spotify_title, language="English"):
#         """SpotifyのタイトルからListen NotesのURLを取得"""
#         episode = self.search_episode(spotify_title, language)
#         if episode:
#             return episode.get('listennotes_url')
#         return None
